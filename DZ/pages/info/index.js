...
export class InfoPage {
    ...
    render() {
        ...
        // Устанавливаем путь к 3D модели (поместите ваш .glb файл в папку models)
        // Можно использовать разные модели для разных товаров
        const modelPath = "../../models/space_station.glb"; // Замените на вашу модель
