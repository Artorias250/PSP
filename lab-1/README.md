...
1. [<a name="toc_title">Название работы</a>](#title)
2. [<a name="toc_target">Цель работы</a>](#target)
3. [<a name="toc_main">Основное задание</a>](#main)
4. [<a name="toc_additional">Дополнительное задание</a>](#additional)

---

## <a name="title">1. Название работы</a>
...
## <a name="main">3. Основное задание</a>
...
## <a name="additional">4. Дополнительное задание</a>
